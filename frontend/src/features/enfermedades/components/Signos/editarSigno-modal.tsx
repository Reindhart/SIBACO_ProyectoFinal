...
import type { Sign } from '../signos-tab'

type EditSignModalProps = {
  sign: Sign
  onClose: () => void
  onSave: () => void
}

export default function EditSignModal({ sign, onClose, onSave }: EditSignModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.put(`/api/signs/${sign.id}`, formData)
      
      onSave()
    } catch (err: any) {
      setError(err.message || 'Error al actualizar el signo clínico')
      ...
      <div className="modal-box max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-xl">Editar Signo Clínico</h3>
